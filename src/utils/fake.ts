...
import { RegisterReqBody, TweetRequestBody } from '~/requestTypes'
...
const PASSWORD = 'Aluhabaz3105@'
// ID của tài khoản của mình, dùng để follow người khác
const MYID = new ObjectId('6517dbe5da80943516c60099')
